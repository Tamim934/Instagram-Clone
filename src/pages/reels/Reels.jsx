    ...
    <>
      <div className="text-[#fff] w-[33%] mx-auto pt-[35px] ">
        <div className="w-full h-[87vh]  rounded-[20px] flex items-end gap-[0px] mb-[40px]">
          <div
            className="w-[85%] md:rounded-[6px] overflow-hidden"
            style={{ boxShadow: "0 0 80px 0 #535252" }}
          >
            <video
        ...
        {commentModal ? (
          <div className="bg-[#201f1f] fixed top-[80px] right-[80px] w-[22%] rounded-[7px]">
            ...
            <div className="h-[230px] overflow-scroll"></div>
        ...
        {sendModal ? (
          <div className="bg-[#201f1f] fixed top-[80px] right-[80px] w-[22%] rounded-[7px]">
            ...
            <div className="h-[230px] overflow-auto"></div>
            <div className="w-[86%] mx-auto py-[15px]">
