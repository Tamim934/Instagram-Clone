...
{/* //will sone changes tis to userbio */}
    ...
    <div className=" dark:bg-black dark:text-white">
      <div className="flex justify-center max5:justify-start pt-[50px]">
        <div className=" w-40 h-40  max5:w-20 max5:h-20 relative flex justify-center items-center rounded-full overflow-hidden">
          <img
            src="/src/assets/imagesuserprofile/profileinstagram.jpeg"
            alt="Profile"
        ...
        <div>
          <div className="flex max5:block items-center ml-[50px] max6:ml-[20px]">
            ...
            <div className="flex gap-[20px] ml-[20px]  max5:ml-[0] max5:mt-[20px]">
              <button className="w-[110px] h-[35px] max5:w-[100px] rounded-lg bg-[#dedddd] font-medium hover:bg-[#e5e3e3] max5:text-[15px]">
                Edit Profile
              </button>
          ...
          <div className="flex ml-[50px] mt-[5px] max600:ml-[-65px]">
            <h1 className="w-[300px] text-[16px] max600:w-[300px]">
              footballer for jueventus real madrid alnassr and manu{" "}
            </h1>
          </div>{" "}
            ...
            <div>
              ...
              <div className="flex flex-col items-center justify-center mt-[100px]">
                ...
                <h1 className="mt-[10px] text-center">
                  Save photos and videos that you want to see again. No<br></br>{" "}
            ...
            <div>
              <div className="flex flex-col items-center justify-center mt-[50px] text-center">
                <img
                  ...
                  alt=""
                />
                <h1 className=" font-bold text-[32px] mt-[20px]">
                  Photos of You
                </h1>
...
<Button 
    ...
    >
      ...
      {modal ? (
        <div className="bg-white w-[100%] h-[1300px] relative mt-[-1520px]">
          <div className="flex">
            <div className="bg-[white] w-[350px] h-[880px] overflow-y-scroll overflow-x-hidden">
              <div>
                <div className="flex justify-center pt-[20px]">
