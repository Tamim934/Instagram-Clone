    ...
    if (file) {
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          const response = await axiosRequest.post("/UserProfile/update-UserProfile", formData, {
            headers: {
        ...
        <div>
          ...
          <div className="flex ml-[50px] mt-[30px] gap-[50px] max600:hidden">
            <div className="flex gap-[5px]">
              <h1 className="text-[16px] font-medium flex gap-[5px]">{user.post}<h1 className="text-[16px]">Posts</h1></h1>
              
            </div>
            <div className="flex gap-[5px]">
              <h1 className="text-[16px] font-medium">{user.follower}</h1>
              <h1 className="text-[16px]">followers</h1>
            </div>
            <div className="flex gap-[5px]">
              <h1 className="text-[16px] font-medium">{user.following}</h1>
