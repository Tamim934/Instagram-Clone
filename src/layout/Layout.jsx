...
const Layout = () => {
  ...
  return (
    ...
    <div className='flex justify-between items-center h-[60px] px-[16px] md:hidden'>
        <div>
            <img src={instagramtextlogo} alt="" className='dark:hidden w-[103px]'/>
            <img src={instagramtextlogo2} alt="" className='hidden dark:block w-[103px]'/>
        </div>
        <div>
            <input type="search" placeholder='Поиск' className='bg-[#EFEFEF] dark:bg-[#262626] text-[#737373] dark:text-[#A8A8A8] w-[268px] h-[36px] rounded-[8px] py-[3px] px-[16px]' />
        </div>
    </div>
